...
生成时间: 2026-06-06 19:36:16

| 状态 | 检查项 | 说明 |
|------|--------|------|
| PASS | Final pkl exists | /root/autodl-tmp/photovoltaic_forecasting_pj/output/pv_pipeline/predictions/distributed_predictions_final_full.pkl |
| PASS | Final pkl readable |  |
| PASS | Has 'split' column |  |
| PASS | Has 'test' split | unique values: ['future', 'test', 'train', 'valid'] |
| INFO | Full pkl contains 'future' split | future split FOUND (INFO — full pkl may contain future) |
