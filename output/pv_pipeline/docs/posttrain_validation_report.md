...
| 20 | ✗ FAIL | C16: artifact hash 验证 | 有 2 个文件 hash 不一致（内容被篡改或未重新生成）: ['final_full_pkl: manifest=1dfbd54db950..., actual=FILE_NOT_FOU...', 'final_eval_pkl: manifest=2c12ef4523cb..., actual=FILE_NOT_FOU...'] |
| 21 | ✓ PASS | C16: manifest 生成时间 | 晚于 canonical full pkl 0.40h |
