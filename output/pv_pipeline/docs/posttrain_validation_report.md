...
| 12 | ✓ PASS | C12: dashboard 数据新鲜 | dashboard 晚于 canonical pkl 0.19h |
...
| 20 | ⚠ WARN | C16: manifest 生成时间 | manifest 早于 pkl 0.00h（可能因 auto-sync 或并发写入）；内容一致性以 hash 为准 |
...
| 28 | ✓ PASS | GEO5: S115 scene_v151 test 10-14 | scene 正常 {'mid': 375, 'low': 49, 'clear_peak': 186}，非 all-night |
| 29 | ✓ PASS | GEO5: S115 g_blend_pred test 10-14 | max=827.7，正常 |
| 30 | ✓ PASS | GEO5: S115 power_pred_final test 10-14 | 610/610 行非0，正常 |
| 31 | ✓ PASS | GEO5: S116 scene_v151 test 10-14 | scene 正常 {'mid': 371, 'low': 54, 'clear_peak': 185}，非 all-night |
