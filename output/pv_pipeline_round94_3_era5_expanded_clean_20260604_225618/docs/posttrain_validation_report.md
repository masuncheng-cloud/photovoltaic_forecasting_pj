...
| 10 | ✓ PASS | C10: hourly_nrmse_consistent.csv 正确 | 14 小时数据, NRMSE范围: 2.20%~16.68% |
| 11 | ✗ FAIL | C11: dashboard 一致性校验 | 68/68 FAIL, max_pred=6.02e+00 |
| 12 | ✓ PASS | C12: dashboard 数据新鲜 | dashboard 晚于 canonical pkl 0.25h |
...
| 20 | ✓ PASS | C16: manifest 生成时间 | 晚于 canonical full pkl 0.33h |
...
| 28 | ✓ PASS | GEO5: S115 scene_v151 test 10-14 | scene 正常 {'clear_peak': 186, 'mid': 375, 'low': 49}，非 all-night |
| 29 | ✓ PASS | GEO5: S115 g_blend_pred test 10-14 | max=827.7，正常 |
| 30 | ✓ PASS | GEO5: S115 power_pred_final test 10-14 | 610/610 行非0，正常 |
| 31 | ✓ PASS | GEO5: S116 scene_v151 test 10-14 | scene 正常 {'clear_peak': 185, 'mid': 371, 'low': 54}，非 all-night |
| 32 | ✓ PASS | GEO5: S116 g_blend_pred test 10-14 | max=836.3，正常 |
