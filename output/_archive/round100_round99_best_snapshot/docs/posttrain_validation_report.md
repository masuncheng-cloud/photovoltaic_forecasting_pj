...
| 10 | ✓ PASS | C10: hourly_nrmse_consistent.csv 正确 | 14 小时数据, NRMSE范围: 2.20%~17.63% |
| 11 | ✓ PASS | C11: dashboard 一致性校验 | 68 站, 全部 PASS |
| 12 | ✓ PASS | C12: dashboard 数据新鲜 | dashboard 晚于 canonical pkl 1.62h |
...
| 17 | ✗ FAIL | C16: manifest.json 存在 | 文件不存在 |
...
| 25 | ✓ PASS | GEO5: S115 scene_v151 test 10-14 | scene 正常 {'mid': 376, 'clear_peak': 185, 'low': 49}，非 all-night |
| 26 | ✓ PASS | GEO5: S115 g_blend_pred test 10-14 | max=827.9，正常 |
| 27 | ✓ PASS | GEO5: S115 power_pred_final test 10-14 | 610/610 行非0，正常 |
| 28 | ✓ PASS | GEO5: S116 scene_v151 test 10-14 | scene 正常 {'mid': 371, 'clear_peak': 185, 'low': 54}，非 all-night |
| 29 | ✓ PASS | GEO5: S116 g_blend_pred test 10-14 | max=836.3，正常 |
| 30 | ✓ PASS | GEO5: S116 power_pred_final test 10-14 | 610/610 行非0，正常 |
| 31 | ✓ PASS | C17: 站点数量一致性 | full=69, eval=68，相差1站 |
| 32 | ✓ PASS | BIAS: 口径说明 | BIAS = mean(power_pred_final - power_mw); BIAS > 0 表示预测偏高，BIAS < 0 表示预测偏低 |
